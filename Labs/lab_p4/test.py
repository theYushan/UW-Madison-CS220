...
expected_json =    {"1": (TEXT_FORMAT, 'Kanto'),
                    "2": (TEXT_FORMAT, 'Fire'),
                    "3": (TEXT_FORMAT, 'Steel'),
                    "4": (TEXT_FORMAT, 106),
                    "5": (TEXT_FORMAT, 150),
                    ...
                    "17": (TEXT_FORMAT, True),
                    "18": (TEXT_FORMAT, True),
                    "19-1": (TEXT_FORMAT, True),
                    "19-2": (TEXT_FORMAT, False),
                    "19-3": (TEXT_FORMAT, False),
                    "19-4": (TEXT_FORMAT, False),
                    "19-5": (TEXT_FORMAT, True),
                    "20": (TEXT_FORMAT, 'Fire is stronger than Grass')}
